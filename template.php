 ...
 */
function teamwork_15_preprocess_maintenance_page(&$variables) {
 ...
 */
function teamwork_15_preprocess_layout(&$variables) {
  if ($variables['content']['header']) {
    $variables['content']['header'] = '<div class="l-header-inner">' . $variables['content']['header'] . '</div>';
  }

$var1 = theme_get_setting('teamwork_15_juiced_main_background');
$var2 = theme_get_setting('teamwork_15_juiced_big_statement_background');
$var3 = theme_get_setting('teamwork_15_juiced_main_background_blurred');
$var4 = theme_get_setting('teamwork_15_juiced_big_statement_background_blurred');
...
$var5 = theme_get_setting('teamwork_15_body_main_background');
$var6 = theme_get_setting('teamwork_15_footer_main_background');
$var7 = theme_get_setting('teamwork_15_body_main_background_blurred');
$var8 = theme_get_setting('teamwork_15_footer_main_background_blurred');
...
if (theme_get_setting('teamwork_15_cdn') > 0)
{
...
backdrop_add_css('themes/teamwork_15/css/style.css', array('every_page' => TRUE, 'preprocess' => TRUE));

if (theme_get_setting('teamwork_15_script1') > 0)
{
...
if (theme_get_setting('teamwork_15_script2') > 0)
{
...
if (theme_get_setting('teamwork_15_script3') > 0)
{
...
if (theme_get_setting('teamwork_15_script4') > 0)
{
...
{
backdrop_add_css('themes/teamwork_15/css/pure.min.css', array('type' => 'file', 'every_page' => TRUE, 'preprocess' => TRUE));
backdrop_add_css('themes/teamwork_15/css/style.css', array('type' => 'file', 'every_page' => TRUE, 'preprocess' => TRUE));
}

backdrop_add_js("themes/teamwork_15/js/scripts.js", array('type' => 'file', 'scope' => 'footer', 'every_page' => TRUE, 'preprocess' => TRUE));
 ...
 */
function teamwork_15_field__taxonomy_term_reference($variables) {
  $output = '';
 ...
 */
function teamwork_15_preprocess_image_style(&$vars) {
  $vars['attributes']['class'][] = 'pure-img';
}

function teamwork_15_button(&$vars) {
 ...
 */
function teamwork_15_form_alter(&$form, &$form_state, $form_id) {
...
function teamwork_15_menu_tree($variables) {
 ...
 */
function teamwork_15_form_element_label(&$variables) {
 ...
 */
function teamwork_15_menu_link(array $variables) {
$element = $variables['element'];
