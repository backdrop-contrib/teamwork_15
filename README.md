...
-- if you would like to use the Admin UI to customize your site, enable the Color module and visit /admin/appearance/settings/teamwork_15
...
Copy the folder teamwork_15_subtheme and paste it in your site's root THEMES directory.  After doing this, you will have at least two folders in that same level: teamwork_15 and teamwork_15_subtheme.  Delete the old teamwork_15_subtheme folder that's inside of the parent theme teamwork_15.  Inside of your top-level teamwork_15_subtheme, rename teamwork_15_subtheme.info.starterkit to teamwork_15_subtheme.info

After clearing your site cache, visit /admin/appearance/list .  Enable Teamwork 15 Subtheme, and make it your default theme.  Now, you can edit custom styles in this theme while it inherits styles from its parent theme teamwork_15.  When updates come out for the teamwork_15 theme, you can just copy and paste or update the parent theme any time and it won't erase your custom theming work (which is done now in the child theme teamwork_15_subtheme).

You work in the top-level teamwork_15_subtheme theme.

-- if you would like to add custom Javascript to your site, edit the js/scripts.js file.
-- if you would like to add custom CSS to your site, edit the css/your-custom.css file.
-- if you would like to use the Admin UI to customize your site, visit /admin/appearance/settings/teamwork_15_subtheme
...
If you like, you can rename every instance of teamwork_15_subtheme to your own theme name, and by copying and pasting your subtheme folder, you can create more than one subtheme.
...
Visit /admin/appearance/settings/teamwork_15_subtheme and:
